                ...
                >
                  <td data-label="Data Arquivamento">
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      <span className="material-icons" style={{ fontSize: '18px', color: '#64748b' }} aria-hidden="true">
                        archive
                      </span>
                      {item.completedAt ? format(parseISO(item.completedAt), 'dd MMM yyyy', { locale: ptBR }) : 'Data N/A'}
                    </div>
                    {item.completedAt && <small style={{ color: '#999', marginLeft: '26px' }}>{format(parseISO(item.completedAt), 'HH:mm')}</small>}
                  </td>
                            ...
                            <div className="log-timeline">
                              ...
                              {item.startedAt && (
                                <div className="log-item production">
                                  ...
                                  <span className="log-date">{format(parseISO(item.startedAt), 'dd MMM yyyy HH:mm', { locale: ptBR })}</span>
                                </div>
                              )}
                              ...
                              {item.completedAt && (
                                <div className="log-item done">
                                  ...
                                  <span className="log-date">{format(parseISO(item.completedAt), 'dd MMM yyyy HH:mm', { locale: ptBR })}</span>
                                </div>
                              )}
                              ...
                              {item.archivedAt && (
                                <div className="log-item done">
                                  ...
                                  <span className="log-date">{format(parseISO(item.archivedAt), 'dd MMM yyyy HH:mm', { locale: ptBR })}</span>
                                </div>
                              )}
                            </div>
                          </div>
